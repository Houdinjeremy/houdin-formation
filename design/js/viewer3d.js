...
(function(){
  ...
  /* L'ordre définit celui des onglets.
     Les modèles Sketchfab retenus sont tous en CC BY : usage commercial permis,
     attribution obligatoire — d'où le champ `credit`, affiché sous la scène. */
  var ENGINS = [
    {
    ...
    { id:"r485", code:"R485", nom:"Gerbeur",
      schema:"gerbeur-accompagnant", sketchfab:"", src:"",
      note:"Conducteur accompagnant, catégorie 1" }
  ];
